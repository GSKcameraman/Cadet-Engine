...
//makes an orthographic matrix, requires right, left, top, bottom, near, far.
void mat4f_make_perspective_orthographic(mat4f_t* m, float right, float left, float top, float bottom, float near, float far);
